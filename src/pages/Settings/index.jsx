...
const Settings = () => {
  ...
  const availablePermissions = [
    {
      ...
      description: "Add, edit, delete members",
    },
    {
      value: "bookings",
    ...
    },
    {
      ...
      description: "Manage other admin users",
    },
    {
      value: "billing",
  ...
  const handleEditAdmin = () => {
    ...
    const updatedAdmins = admins.map((admin) =>
      admin.id === selectedAdmin.id ? { ...admin, ...selectedAdmin } : admin
    );
        ...
        <table>
          ...
          <tbody>
            {filteredAdmins.map((admin) => (
              <tr
                key={admin.id}
                className={admin.isSuperAdmin ? "super-admin-row" : ""}
              >
                <td>
                ...
                <td>
                  <div className="role-badge">
                    ...
                    {admin.isSuperAdmin && (
                      <span className="super-admin-badge">SUPER</span>
                    )}
                  </div>
                </td>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              ...
              <button onClick={handleAddAdmin} className="primary">
                Add Admin
              </button>
            </div>
          </div>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              ...
              <button onClick={handleEditAdmin} className="primary">
                Save Changes
              </button>
            </div>
          </div>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              ...
              <button onClick={handleDeleteAdmin} className="danger">
                Delete Admin
              </button>
            </div>
          </div>
